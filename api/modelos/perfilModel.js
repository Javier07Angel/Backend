...
const Mymodel = mongoose.model("perfil",perfilShema)
...
perfilModel.Guardar = function(post, callback){
...
perfilModel.Existecodigo = function(post, callback){
    ...
    // var posicion = bdperfil.findIndex((item)=> item.email == post.email)
...
perfilModel.ListarperfilActivos = function(post, callback){
...
perfilModel.Listar = function(post, callback){
...
perfilModel.ListarId = function(post, callback){
...
perfilModel.Actualizar = function(post, callback){
...
perfilModel.Eliminar = function(post, callback){
...
module.exports.perfilModel = perfilModel
config.origins = [
    "http://localhost:4200"
]
