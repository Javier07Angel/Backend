...
const Mymodel = mongoose.model("contratos",contratosShema)





contratosModel.Guardar = function(post, callback){
...
contratosModel.Existecodigo = function(post, callback){
    ...
    // var posicion = bdcontratos.findIndex((item)=> item.email == post.email)
...
contratosModel.ListarcontratosActivos = function(post, callback){
...
contratosModel.Listar = function(post, callback){
...
contratosModel.ListarId = function(post, callback){
...
contratosModel.Actualizar = function(post, callback){
...
contratosModel.Eliminar = function(post, callback){
...
module.exports.contratosModel = contratosModel
config.origins = [
    "http://localhost:4200"
]
